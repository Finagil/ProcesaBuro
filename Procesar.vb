...
Module Procesar
    ...
    Sub Main()
        ...
        Dim D As New System.IO.DirectoryInfo(My.Settings.RutaBuro)
        Dim DB As New System.IO.DirectoryInfo(My.Settings.RutaBuroBackup)
        If Not DB.Exists Then
            System.IO.Directory.CreateDirectory(My.Settings.RutaBuroBackup)
        End If
        ...
        For i As Integer = 0 To F.Length - 1
            ...
            File.Move(F(i).FullName, My.Settings.RutaBuroBackup & F(i).Name)
        Next
        'PARTE 2++++++++++++++++++++++++++++++++
            F = D.GetFiles("*.txt")
        For i As Integer = 0 To F.Length - 1
        ...
        While Not f1.EndOfStream
            ...
            If Trim(Datos(55)) <> "" Then ' nombre de la caracteristica
                ...
                If RFCant <> Datos(4) And RFCant <> "" Then
                    TA.DeleteRFC(RFC)
                    TA.Insert(RFC, My.Settings.MES, Vars(0), Vars(1), Vars(2), Vars(3), Vars(4), Vars(5), Vars(6), Vars(7), Vars(8), Vars(9),
    ...
    Sub LeeArchivo2(ByVal F As String)
        ...
        While Not f1.EndOfStream
            ...
            Else
                RFC = Datos(2)
            End If
            TA.Insert(RFC, My.Settings.MES, Datos(0 + 5), Datos(1 + 5), Datos(2 + 5), Datos(3 + 5), Datos(4 + 5), Datos(5 + 5), Datos(6 + 5), Datos(7 + 5), Datos(8 + 5), Datos(9 + 5),
                                        Datos(10 + 5), Datos(11 + 5), Datos(12 + 5), Datos(13 + 5), Datos(14 + 5), Datos(15 + 5), Datos(16 + 5), Datos(17 + 5), Datos(18 + 5), Datos(19 + 5),
